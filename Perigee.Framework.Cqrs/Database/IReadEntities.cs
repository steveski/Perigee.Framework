namespace Perigee.Framework.Cqrs.Database
{
    using System;
    using System.Linq;
    ...
    public interface IReadEntities
    {
        ...
        /// </typeparam>
        /// <param name="query">
        ///     Query for  a set of TEntity instances from an underlying relational
        ///     data store.
        /// </param>
        /// <param name="expression">
        ///     Related entity instance set(s) that the underlying relational
        ///     data store should return along with the set of TEntity instances.
        /// </param>
        /// <returns>
        ///     IQueryable for set of TEntity instances informing the underlying relational data
        ///     store to also return related entities identified in the expression argument.
        /// </returns>
